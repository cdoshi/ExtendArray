...
a,d,!1);return e},stat:function(b,a,d,e){if(void 0===e){if(void 0===b)return[];if(!this.checkArray(b)||"mean"!==a&&"max"!==a&&"min"!==a&&"popstd"!==a&&"samstd"!==a&&"absmax"!==a&&"absmin"!==a&&"add"!==a)return!1;void 0===d&&(d="horizontal")}if("vertical"===d)return b=m.transpose(b),m.stat(b,a);e=this.dimensions(b);var c;d=[];if(1===e.length)if(c=e[0],"mean"===a){for(e=a=0;e<c;e++)a+=b[e];d[0]=a/c}else if("max"===a)d[0]=Math.max.apply(null,b);else if("absmax"===a)d[0]=Math.max.apply(null,this.scalarOperation(b,
"abs"));else if("absmin"===a)d[0]=Math.min.apply(null,this.scalarOperation(b,"abs"));else if("min"===a)d[0]=Math.min.apply(null,b);else if("add"===a){for(e=a=0;e<c;e++)a+=b[e];d[0]=a}else"popstd"===a?(this.stat(b,"mean"),d[0]=Math.sqrt(this.stat(this.power(this.scalarOperation(b,"subtract",this.stat(b,"mean")[0]),2),"add")[0]/c)):"samstd"===a&&(this.stat(b,"mean"),d[0]=Math.sqrt(this.stat(this.power(this.scalarOperation(b,"subtract",this.stat(b,"mean")[0]),2),"add")[0]/(c-1)));else for(c=e.shift(),
e=0;e<c;e++)d[e]=this.stat(b[e],a,!1);return d},subset:function(b,a,d){if(void 0===d){if(void 0===b)return[];if(!this.checkArray(b)&&!this.checkArray(a))return!1}d=this.dimensions(b);var e=[],c,f;if(a.length>d.length)return!1;if(a.length<d.length)for(f=0;f<d.length-a.length;f++)a[a.length]=":";for(f=0;f<a.length;f++)if("number"===typeof a[f])a[f]=[a[f]];else if(":"===a[f])for(a[f]=[],c=0;c<d[f];c++)a[f][c]=c;c=":"===a[0]?b[0].length:a[0].length;if(1===d.length)for(f=0;f<c;f++)e[f]=b[a[0][f]];else for(f=
0;f<c;f++)e[f]=this.subset(b[a[0][f]],a.slice(1),!1);return e},determinant:function(b,a,d){void 0===a&&(a=!0);var e=this.dimensions(b);if(a){if(void 0===b)return[];if(!this.checkArray(b))return!1;if(2!==e.length)return console.error("Supports 2D matrices only"),!1;if(e[0]!==e[1])return console.error("Supports square matrices only"),!1;b=this.scalarOperation(b,"copy");void 0===d&&(d=0)}if(1===e[0])return b[0][0];if(2===e[0])return b[0][0]*b[1][1]-b[0][1]*b[1][0];var c=this.serialIndex(1,e[0]-1);a=
e[0];var f=e[1],g,h;for(g=e=1;g<a;g++)for(h=1;h<f;h++)b[g][h]=b[g][h]*b[0][0]-b[g][0]*b[0][h];Math.abs(b[1][1])>Math.pow(10,5)?(e=Math.pow(10,-5),b=this.scalarOperation(b,"multiply",e)):Math.abs(b[1][1])<Math.pow(10,-5)&&(e=Math.pow(10,5),b=this.scalarOperation(b,"multiply",e));c=this.subset(b,[c,c]);d=this.determinant(c,!1,d);d/=e;for(g=1;g<a-1;g++)d/=b[0][0];return d},serialIndex:function(b,a,d,e){void 0===d&&(d=1);void 0===e&&(e=[]);if(!this.checkArray(e))return console.error("exclude argument is an array"),
!1;var c=[],f=-1,g=!1;for(0!==e.length&&(g=!0);b<=a;b+=d)g&&(f=e.indexOf(b)),-1===f&&(c[c.length]=b);return c},inverse:function(b,a){void 0===a&&(a=!0);var d=this.dimensions(b);if(a){if(void 0===b)return[];if(!this.checkArray(b))return!1}if(2!==d.length)return console.error("Supports 2D matrices only"),!1;if(d[0]!==d[1])return console.error("Supports square matrices only"),!1;d=this.determinant(b);return 0===d?(console.error("Inverse of singular matrix cannot be determined"),!1):this.scalarOperation(this.adjoint(b,
!1),"divide",d)},pseudoinverse:function(b){if(void 0===b)return[];if(!this.checkArray(b))return!1;var a=this.dimensions(b);if(2<a.length)return console.error("Supports only upto 2D"),!1;var d=this.transpose(b);return a[0]>a[1]?this.crossProduct(this.inverse(this.crossProduct(d,b),!1),d):this.crossProduct(d,this.inverse(this.crossProduct(b,d),!1))},adjoint:function(b,a){void 0===a&&(a=!0);if(a){if(void 0===b)return[];if(!this.checkArray(b))return!1}var d=this.dimensions(b);if(a){if(2!==d.length)return console.error("Supports 2D matrices only"),
!1;if(d[0]!==d[1])return console.error("Supports square matrices only"),!1}return this.transpose(l.bind(this,b,d)())},print:function(b){if(void 0===b)return[];if(!this.checkArray(b))return!1;var a=this.dimensions(b),d,e="";if(2<a.length)return console.error("Supports upto 2D matrices only"),!1;if(2===a.length){d=a[0];for(var a=a[1],e=e+"[",c=0;c<d;c++){for(var e=e+"[",f=0;f<a;f++)e=f===a-1?e+b[c][f]:e+(b[c][f]+", ");e=c!==d-1?e+"],":e+"]"}}else for(d=a[0],e+="[",c=0;c<d;c++)e=c===d-1?e+b[c]:e+(b[c]+
", ");return e+"]"}};return m}"undefined"===typeof Library&&(k.ExtendArray=l())})(window);